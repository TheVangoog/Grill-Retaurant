                    ...
                    <div class="row" id="Container">
                        <div class="col-md-3 col-sm-6 mix portfolio-item Pizza">       
                            <div class="portfolio-wrapper">                
                                ...
                                <div class="label-text">
                                    <h3><a href="single-post.php">Vege Pizza</a></h3>
                        ...
                        <div class="col-md-3 col-sm-6 mix portfolio-item ginger">       
                            <div class="portfolio-wrapper">                
                                ...
                                <div class="label-text">
                                    <h3><a href="single-post.php">Ginger Tea</a></h3>
                        ...
                        <div class="col-md-3 col-sm-6 mix portfolio-item pizza">       
                            <div class="portfolio-wrapper">                
                                ...
                                <div class="label-text">
                                    <h3><a href="single-post.php">Fresh Salad</a></h3>
                        ...
                        <div class="col-md-3 col-sm-6 mix portfolio-item pasta">       
                            <div class="portfolio-wrapper">                
                                ...
                                <div class="label-text">
                                    <h3><a href="single-post.php">Healthy Herbal Tea</a></h3>
                        ...
                        <div class="col-md-3 col-sm-6 mix portfolio-item drink">       
                            <div class="portfolio-wrapper">                
                                ...
                                <div class="label-text">
                                    <h3><a href="single-post.php">Fruit Salad</a></h3>
                        ...
                        <div class="col-md-3 col-sm-6 mix portfolio-item hamburger">       
                            <div class="portfolio-wrapper">                
                                ...
                                <div class="label-text">
                                    <h3><a href="single-post.php">Spicy Hamburger</a></h3>
                        ...
                        <div class="col-md-3 col-sm-6 mix portfolio-item pizza">       
                            <div class="portfolio-wrapper">                
                                ...
                                <div class="label-text">
                                    <h3><a href="single-post.php">Chocolate Cake</a></h3>
                                    <span class="text-category">$16.00</span>
                                </div>
                            </div>          
                        </div>
                        <div class="col-md-3 col-sm-6 mix portfolio-item pasta">       
                            <div class="portfolio-wrapper">                
                                ...
                                <div class="label-text">
                                    <h3><a href="single-post.php">Berry Taste</a></h3>
                        ...
                        <div class="col-md-3 col-sm-6 mix portfolio-item hamburger">       
                            <div class="portfolio-wrapper">                
                                ...
                                <div class="label-text">
                                    <h3><a href="single-post.php">Onion Grilled</a></h3>
                                    <span class="text-category">$16.00</span>
                                </div>
                            </div>          
                        </div>
                        <div class="col-md-3 col-sm-6 mix portfolio-item drink">       
                            <div class="portfolio-wrapper">                
                                ...
                                <div class="label-text">
                                    <h3><a href="single-post.php">Another Ginger</a></h3>
                        ...
                        <div class="col-md-3 col-sm-6 mix portfolio-item ginger">       
                            <div class="portfolio-wrapper">                
                                ...
                                <div class="label-text">
                                    <h3><a href="single-post.php">Mocha Coffee</a></h3>
                                    <span class="text-category">$16.00</span>
                                </div>
                            </div>          
                        </div>
                        <div class="col-md-3 col-sm-6 mix portfolio-item pasta">       
                            <div class="portfolio-wrapper">                
                                ...
                                <div class="label-text">
                                    <h3><a href="single-post.php">Dessert Time</a></h3>
                                    <span class="text-category">$16.00</span>
                                </div>
                            </div>          
                        </div>
